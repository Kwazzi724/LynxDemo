...
HandyMusic_Song_BaseAddress	EQU $4000
HandyMusic_Song_Priorities	EQU HandyMusic_Song_BaseAddress + 0
HandyMusic_Song_TrackAddrLo	EQU HandyMusic_Song_BaseAddress + 4
HandyMusic_Song_TrackAddrHi	EQU HandyMusic_Song_BaseAddress + 8
HandyMusic_Song_InstrLoLo	EQU HandyMusic_Song_BaseAddress + 12
HandyMusic_Song_InstrLoHi	EQU HandyMusic_Song_BaseAddress + 13
HandyMusic_Song_InstrHiLo	EQU HandyMusic_Song_BaseAddress + 14
HandyMusic_Song_InstrHiHi	EQU HandyMusic_Song_BaseAddress + 15
;************************************
...
;*******************************
	include "HM_Mus.asm"
;**************************
; Sample Playback Routine *
;**************************
	include "HM_Sampl.asm"
;****************************************************************
; HandyMusic_Main::						*
...
; enable stereo and get HandyMusic ready to go.
	...
	LDX#3
.killallchannels
	jsr HandyMusic_FreeChannel ; Make sure all channels are open.
	DEX
	bpl .killallchannels
...
HandyMusic_Note dc.b "Now a cleaner, more organized cat with short notes and stable waves."
;************************
